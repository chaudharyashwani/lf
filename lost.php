...
<body>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <div class="container p-3 my-3 bg- cyan darken-3 text-white">
                <h2 align="center" > "Please Upload the photo of the lost product "</h2>
    ...
    <div class="container">
      ...
      <div class="md-form">
        ...
        <label for="materialLoginFormEmail">Description (with contact info) </label>
      </div>
      <div>
...
<div class="container">
  <p> Thankyou, With the help of Image processing technique, Our software will match your product with our already FOUND product and if we able to find it then We will contact you soon</p>
</div>
